...
Oshiheteo = pygame.mixer.Channel(0).play(pygame.mixer.Sound("LAB8/sounds/Ninety One - Қайтадан.mp3"))
...
while exit:
    ...
    if (counter > 9):
        speed -= 0.005
        pygame.mixer.Channel(3).play(pygame.mixer.Sound("LAB8/sounds/manycoins.mp3"))
        counter -= 10
